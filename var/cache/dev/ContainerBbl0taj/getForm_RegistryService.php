...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\ProfilType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ProfilType']) ? $this->services['AppBundle\\Form\\ProfilType'] : ($this->services['AppBundle\\Form\\ProfilType'] = new \AppBundle\Form\ProfilType())) && false ?: '_'};
